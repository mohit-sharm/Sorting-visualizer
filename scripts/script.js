...
const sliderNumber = document.getElementById("numberNumber");
const sliderSpeed = document.getElementById("speedNumber");
...
const changeArrayValues = function () {
  for (let i = 0; i < arr.length; i++) {
    ...
    valueBox.children[i].computedStyleMap.backgroundColor = "brown";
  }
};
...
const activateButton = function (num) {
  ...
  else if (num == 3) x = insertionSortButton;
  else if (num == 4) x = selectionSortButton;
